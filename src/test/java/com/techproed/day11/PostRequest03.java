...
Dönen response un Status kodunun 201 ve response body nin aşağıdaki gibi olduğunu test edin
   {
    ...
    public void test(){
        ...
        response.then().
                assertThat().
                statusCode(expectedRequest.getInt("statusCode")). // burda Integera cast yapmamizi istiyor. onun yerine getInt yapabiliriz
                body("completed", equalTo(expectedRequest.getBoolean("completed")),
                        "title",equalTo(expectedRequest.get("title")), // expectedRequestten sonra get yada getString farkedermi?
        ...
        Assert.assertEquals(expectedRequest.get("userId"),json.get("userId")); // expectedRequestten sonra get yada getInt farkedermi?
        ...
        Assert.assertEquals(expectedRequest.get("userId"),actualDataMap.get("userId")); // expectedRequestten sonra get yada getInt farkedermi?
